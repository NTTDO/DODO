...
# Tạo bản ánh xạ ngược
qam_64_inverse_map = {v: k for k, v in qam_64_gray_map.items()}

# In phần thực (real parts)
print("Phần thực:")
for key, value in qam_64_inverse_map.items():
    print(f""
          f"11'b{value}: data_out = {float_to_float_point.float_to_ieee754(key[0])};")

# In phần ảo (imaginary parts)
print("\nPhần ảo:")
for key, value in qam_64_inverse_map.items():
    print(f"6'b{value}: data_out = {float_to_float_point.float_to_ieee754(key[1])};")
